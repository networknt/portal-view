...
export default function GlobalProperties(props) {
    ...
    const url = '/config-server/configs?offset=' + page*rowsPerPage + '&limit=' + rowsPerPage;
    ...
    const handleCreate = () => {
        props.history.push('/app/form/createCofnigGlobal');
    };
    ...
    if (loading) {
      ...
      wait = (
        <div>
          <GlobalList {...props} globals={globals} />
          <TablePagination
